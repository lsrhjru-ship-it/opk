...
const LAW_DATA = [
  ...
  { category: "건물 알피", name: "경찰서 털이1차", fine: "200,000,000원", detention: "", process: "공표 허가 -> 벨 울림 -> 사이드공지 2회 -> 무력진압 3회", etc: "구금 최소 10분 / 금지자리 필수 확인" },
  { category: "건물 알피", name: "경찰서 털이2차", fine: "200,000,000원", detention: "40분", process: "공표 허가 -> 벨 울림 -> 사이드공지 2회 -> 무력진압 3회", etc: "금지자리 필수 확인" },
